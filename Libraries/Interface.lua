		...
		Library.Sections.Textbox = function(self, Data)
			...
			do
				...
				Items["Input"] = Instances:Create("TextBox", {
					...
					BorderColor3 = FromRGB(0, 0, 0),
					Text = "",
					Size = (StringLen(Textbox.Name or "") == 0) and UDim2New(1, 0, 1, 0) or UDim2New(0.6000000238418579, 0, 1, 0),
					BorderSizePixel = 0,
				...
				Items["Text"] = Instances:Create("TextLabel", {
					...
					TextSize = 14,
					BackgroundColor3 = FromRGB(255, 255, 255),
					Visible = StringLen(Textbox.Name or "") > 0,
				})
				Items["Text"]:AddToTheme({ TextColor3 = "Text" })
		...
		Library.CreateSettingsPage = function(self, Window)
			...
			do
				...
				ConfigsSection:Button({
					...
					Callback = function()
						if ConfigSelected ~= nil then
							local Success, _ = Library:LoadConfig(
